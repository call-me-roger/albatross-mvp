...
import { sendUnstakeTransaction } from 'doric-core/actions/staking'
    ...
    <Box>
      <div className="header-row">
        <div style={{ width: '80%', margin: 'auto', padding: '1rem 0px' }}>
          {t(`Confirm your unstaking`)}
        </div>
      </div>
      <div className="row-container">
        <div className="row1">
          <span className="a">{t(`Unstake`)}</span>
...
export default connect(state, { sendUnstakeTransaction })(ConfirmUnstake)
